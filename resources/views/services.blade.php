        ...
        <div class="container pt-8 pt-md-14">
            <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-1 position-relative order-lg-2" data-cue="zoomIn">
                    ...
                    <figure class="rounded"><img src="./assets/img/photos/TeslaModel3.jpg" srcset="./assets/img/photos/TeslaModel3.jpg 2x" alt="" /></figure>
                </div>
                <!--/column -->
                <div class="col-lg-5 mt-lg-n10 text-center text-lg-start" data-cues="slideInDown" data-group="page-title" data-delay="600">
                    <h1 class="display-1 mb-5">Al Khoury car rental office</h1>
                    <p class="lead fs-25 lh-sm mb-7 px-md-10 px-lg-0">we offer convenient and reliable car rental services to meet all your transportation needs.</p>
                    <div class="d-flex justify-content-center justify-content-lg-start" data-cues="slideInDown" data-group="page-title-buttons" data-delay="900">
                        <span><a href="{{}}" class="btn btn-lg btn-primary rounded-pill me-2">Explore Cars</a></span>
                        <span><a href="#" class="btn btn-lg btn-outline-primary rounded-pill">Our Services</a></span>
                    </div>
                </div>
                <!--/column -->
            </div>
            ...
            <div class="row gx-md-8 gy-8 text-center mb-14 mb-md-17">
                ...
                <!--/column -->
                <div class="col-md-6 col-lg-3">
                    <div class="icon btn btn-circle btn-lg btn-primary pe-none mb-5"> <i class="uil uil-shield-exclamation"></i> </div>
